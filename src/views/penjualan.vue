                ...
                <table class="table table-bordered">
                    ...
                    <tfoot>
                         <tr>
                            ...
                            <td style="margin: 0; padding: 0;">
                                <input class="form-control" type="number" :options="harga"/>
                            </td>
                            <td>
                                {{det.qty * det.harga}}
                            </td>
...
export default {
  ...
  methods: {
    ...
    simpan() {
      ...
      axios.post("/api/master/penjualan", this.vm).then(() => 
      {
    ...
    harga(){
        axios
      .get("/api/master/item/all")
      .then(response => (this.listItem = response.det.harga));
    }
  },
  mounted() {
    axios
